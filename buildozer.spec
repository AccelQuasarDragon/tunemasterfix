...
source.include_exts = py,png,jpg,kv,atlas,html,css,json,ico
...
source.exclude_dirs = tests, bin, venv, Musictransfer

# (list) List of exclusions using pattern matching
# Do not prefix with './'
#source.exclude_patterns = license,images/*/*.jpg

# (str) Application and (method 1)
version = 0.1
...
requirements = python3,kivy,cryptography==2.8,authlib,cffi==1.17.1,pycparser==2.22,blinker==1.8.2,click==8.1.7,colorama==0.4.6,itsdangerous==2.2.0,Jinja2==3.1.4,MarkupSafe==2.1.5,werkzeug==2.2.2,google-api-python-client==2.144.0,google-api-core==2.19.2,google-auth==2.34.0,cachetools==5.5.0,pyasn1_modules==0.4.0,pyasn1==0.6.0,rsa==4.9,googleapis-common-protos==1.65.0,protobuf==5.28.0,proto-plus==1.24.0,requests==2.32.3,certifi==2024.8.30,charset-normalizer==3.3.2,idna==3.8,urllib3==2.2.2,google-auth-httplib2==0.2.0,httplib2==0.22.0,pyparsing==3.1.4,uritemplate==4.1.1,google-auth-oauthlib==1.2.1,requests-oauthlib==2.0.0,oauthlib==3.2.2,jaro-winkler==2.0.3,spotipy==2.24.0,redis==5.0.8,youtube-search==2.1.2,Flask==2.0.3
...
#requirements.source_hostpython = https://github.com/kivy/python-for-android.git


# (str) Presplash of the application
presplash.filename = static/TuneTransfer_splashscreen.png

# (str) Icon of the application
icon.filename = static/TuneTransferLogo.png
...
# (str) Android NDK version to use0
android.ndk = 25b
...
#android.ndk_path = /home/rducker/.buildozer/android/platform/android-sdk

# (str) Android SDK directory (if empty, it will be automatically downloaded.)
#android.sdk_path = ./home/rducker/.buildozer/android/platform/android-ndk-r25b
