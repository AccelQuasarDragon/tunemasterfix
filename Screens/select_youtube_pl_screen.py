...
class SelectYtPlScreen(Screen):
    def __init__(self, **kw):
        ...
        chose_name_text_input = TextInput(multiline=False, size_hint=(.4, .04), pos_hint={'x': .3125, 'y': .62})
        ...
        scroll_view = ScrollView(do_scroll_y=False, do_scroll_x=True, pos_hint={'x': .265, 'y': .20}, size_hint=(.5, .3))
        ...
        for playlist_name, playlist_id in self.playlists.items():
            pl_button = Button(text=playlist_name, width=500, size_hint_x=None,
